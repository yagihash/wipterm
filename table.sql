DROP TABLE 'entries';
CREATE TABLE 'entries' ( 'id' INTEGER PRIMARY KEY AUTOINCREMENT, 'login_name' VARCHAR(20) NOT NULL UNIQUE, 'kg_id' INTEGER NOT NULL, 'title' VARCHAR(256) NOT NULL, 'class_id' INTEGER NOT NULL, 'grade_id' INTEGER NOT NULL, 'order' INTEGER NOT NULL DEFAULT 0, 'handout_name' VARCHAR(256) NOT NULL, 'slide_name' VARCHAR(256) NOT NULL, 'password' VARCHAR(128) NOT NULL );
